                            ...
                            mFirebaseFirestore.collection("images").document(itemName.getText().toString())
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            Toast.makeText(NewItemUpload.this, "Images is uploaded", Toast.LENGTH_LONG).show();
                                            startActivity(new Intent(getApplicationContext(), HomePage.class));
                                        }
                                    }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(NewItemUpload.this, "Failed to upload", Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                        else if(!task.isSuccessful()) {
                            Toast.makeText(NewItemUpload.this, Objects.requireNonNull(task.getException()).toString(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
